...
set rc [catch {
  ...
  set_property ip_repo_paths z:/EE460M/Lab7_partb/Lab7_partb.cache/ip [current_project]
  set_property ip_output_repo z:/EE460M/Lab7_partb/Lab7_partb.cache/ip [current_project]
  add_files -quiet Z:/EE460M/Lab7_partb/Lab7_partb.runs/synth_1/Complete_MIPS.dcp
...
set rc [catch {
  ...
  if { [file exists Z:/EE460M/Lab7_partb/Lab7_partb.runs/synth_1/Complete_MIPS.hwdef] } {
    catch { write_sysdef -hwdef Z:/EE460M/Lab7_partb/Lab7_partb.runs/synth_1/Complete_MIPS.hwdef -bitfile Complete_MIPS.bit -meminfo Complete_MIPS.mmi -file Complete_MIPS.sysdef }
  }
