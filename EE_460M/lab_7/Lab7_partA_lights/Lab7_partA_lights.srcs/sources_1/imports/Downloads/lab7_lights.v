...
module Complete_MIPS(CLK, RST, HALT, /*A_Out, D_Out,*/ leds/*, light*/);
  ...
  Divider #(25000000) div(CLK, divCLK);
  ...
  begin
    ...
    case (state)
      ...
      2: begin //execute
		...
		else if (opsave == sadd) alu_result = ((alu_in_A + alu_in_B) > (2^32-1)) ? (2^32-1) : (alu_in_A + alu_in_B);
      ...
      3: begin //prepare to write to mem
        nstate = 3'd0;
        if ((format == R)||(`opcode == addi)||(`opcode == andi)||(`opcode == ori)) regw = 1;	// enable write to Reg File.
