...
module VGADisplayController (pixel_clock, color, x_coord, y_coord, hsync, vsync, RED, GREEN, BLUE);
	input pixel_clock;
	input [11:0] color;
	output hsync, vsync;
	output [3:0] RED, GREEN, BLUE;
	output [31:0] x_coord, y_coord;
	...
	assign x_coord = hcount;
	assign y_coord = vcount;
