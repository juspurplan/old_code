...
#set_property PACKAGE_PIN W17 [get_ports {resume}]					
...
#set_property PACKAGE_PIN U2 [get_ports {coms[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {coms[0]}]
#set_property PACKAGE_PIN U4 [get_ports {coms[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {coms[1]}]
#set_property PACKAGE_PIN V4 [get_ports {coms[2]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {coms[2]}]
#set_property PACKAGE_PIN W4 [get_ports {coms[3]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {coms[3]}]
